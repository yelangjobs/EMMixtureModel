...
function plotprojfig(Xaxis,Xlabel,Simpars,CRBd,CRBa,CRBp,CRBq,mCRBd,mCRBa,...
...
set(gca,'yscale','log')
saveas(h,strcat('CRB_',suffex),'fig')
saveas(h,strcat('CRB_',suffex),'eps')
...
plot(median(errordata),'r','LineWidth',2); grid off
xlabel(Xlabel)
...
saveas(h,strcat('EMvsMOM_1_',suffex),'fig')
saveas(h,strcat('EMvsMOM_1_',suffex),'eps')
...
saveas(h,strcat('EMvsMOM_2_',suffex),'fig')
saveas(h,strcat('EMvsMOM_2_',suffex),'eps')
...
saveas(h,strcat('EMvsMOM_3_',suffex),'fig')
saveas(h,strcat('EMvsMOM_3_',suffex),'eps')
...
saveas(h,strcat('EMvsMOM_4_',suffex),'fig')
saveas(h,strcat('EMvsMOM_4_',suffex),'eps')
...
saveas(h,strcat('EMvsMOM_5_',suffex),'fig')
saveas(h,strcat('EMvsMOM_5_',suffex),'eps')
...
saveas(h,strcat('EMvsMOM_6_',suffex),'fig')
saveas(h,strcat('EMvsMOM_6_',suffex),'eps')
...
[ax,h1,h2]=plotyy(Xaxis,median(emtimedata)',Xaxis,median(momtimedata)',f1,f2)
set(h1,'FaceColor','r')
set(h2,'FaceColor','b')
grid off
...
legend('EM median runtime','MOM median runtime')
h = legend;
set(h, 'interpreter', 'latex')
xlabel(Xlabel)
saveas(h,strcat('runtime_',suffex),'fig')
saveas(h,strcat('runtime_',suffex),'eps')
